...
import 'package:flutter_app/src/bloc/small_property_basic_info_event.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildTextField(
                              ...
                              width: 400,
                              setter: (value) => bloc.add(SmallPropertyNameChanged(value))),
                          _buildTextField(
                              label: "Rakennustyyppi",
                              initialValue: state.buildingType,
                              width: 400,
                              setter: (value) => bloc.add(SmallPropertyBuildingTypeChanged(value))),
                          _buildTextField(
                              label: "Osoite",
                              initialValue: state.address,
                              width: 400,
                              setter: (value) => bloc.add(SmallPropertyAddressChanged(value))),
                        ],
                      ),
                    ),
                  ],
