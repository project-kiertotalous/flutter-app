...
import 'package:flutter_app/src/bloc/SB_excavation_area_bloc.dart';
import 'package:flutter_app/src/bloc/SB_excavation_area_event.dart';
            ...
            children: [
              ...
              InputCell(
                ...
                setter: (value) => excavationAreaBloc.add(
                  AreofTheRemovableSoilChanged(value),
                ),
              ),
