        ...
        children: [
          ...
          LayoutGrid(
            ...
            children: [
              Cell.row(
                checkbox: true,
                checkboxTitle: 'Ikkunat ovat kierrätyskelpoisia',
                checkboxValue: state.areWindowsRecyclable,
                checkboxSetter: (value) => spWindowsBloc.add(
                  AreWindowsRecyclableChanged(value),
                ),
              ),
              Cell.column(
                initialValue: 'Kappalemäärä',
              ),
              Cell.column(
                initialValue: 'Puu (tonnia)',
              ),
              Cell.column(
                initialValue: 'Teräs (tonnia)',
              ),
              Cell.column(
                initialValue: 'Alumiini (tonnia)',
              ),
              Cell.column(
                initialValue: 'Lasi (tonnia)',
              ),
              Cell.row(
                initialValue: 'Puukarmi',
              ),
              Cell.input(
              ...
              Cell.output(
                getter: () => state.woodenFrameWindowWoodTons,
              ),
              Cell.grey(),
              Cell.grey(),
              Cell.output(
                getter: () => state.woodenFrameWindowGlassTons,
              ),
              Cell.row(
                initialValue: 'Teräs',
              ),
              ...
              Cell.grey(),
              Cell.output(
                getter: () => state.steelWindowSteelTons,
              ),
              Cell.grey(),
              Cell.output(
                getter: () => state.steelWindowGlassTons,
              ),
              Cell.row(
                initialValue: 'Alumiini',
              ),
              Cell.input(
                initialValue: state.aluminiumPcs,
                integer: true,
                setter: (value) =>
                    spWindowsBloc.add(AluminiumPcsChanged(value)),
              ),
              Cell.grey(),
              Cell.grey(),
              Cell.output(
                getter: () => state.aluminiumWindowAluminiumTons,
              ),
              Cell.output(
                getter: () => state.aluminiumWindowGlassTons,
              ),
            ],
          ),
        ],
