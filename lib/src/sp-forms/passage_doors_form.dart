...
class PassageDoorsForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SpDoorBloc, SpDoorsState>(builder: (context, state) {
      return Column(
          ...
          LayoutGrid(
            ...
            children: [
              Cell.row(
                ...
                checkbox: true,
                checkboxTitle: 'Kierrätyskelpoisia',
              ...
              Cell.input(
                ...
                setter: (value) => passageBloc.add(
                  PassageShutWoodenDoorsChanged(value),
                ),
              ),
              Cell.input(
              ...
              Cell.input(
                ...
                integer: true,
                setter: (value) => passageBloc.add(
                  PassageShutSteelDoorsChanged(value),
                ),
              ),
              ...
              Cell.input(
                ...
                integer: true,
                setter: (value) => passageBloc.add(
                  PassageGlassSteelDoorsChanged(value),
                ),
              ),
              ...
              Cell.output(getter: () => state.passageDoors.woodenDoorGlassTons),
              Cell.output(
                  getter: () => state.passageDoors.aluminiumDoorGlassTons),
              Cell.output(getter: () => state.passageDoors.steelDoorGlassTons),
