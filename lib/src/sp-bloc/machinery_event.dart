...
class SPElectricalDistributionMachinesAndMetersChanged extends SPMachineryEvent {
  final num value;
...
class SPAreConcreteYardTilesAndWallStonesRecyclableChanged extends SPMachineryEvent {
  final bool value;
...
class SPConcreteYardTilesAndStonesInSquareMetersChanged extends SPMachineryEvent {
  final num value;
